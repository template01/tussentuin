...
<div>
  <template v-for="layout in content">
    ...
    <div v-if="layout.acf_fc_layout === 'background_image'">
      <sectionphoto :class="[layout.addpadding['padding-top'] ? 'mt-80':'', layout.addpadding['padding-bottom'] ? 'mb-80':'']" :photoUrl="layout.content.background_image.sizes.extralarge"></sectionphoto>
    </div>
